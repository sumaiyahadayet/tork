            ...
            ! function() {
                ...
                KTUtil.scrollInit(i, {
                    ...
                    height: function() {
                        ...
                        return n && (t -= parseInt(KTUtil.actualHeight(n)), t -= parseInt(KTUtil.css(n, "marginBottom"))), t -= parseInt(KTUtil.css(e, "paddingTop")), t -= parseInt(KTUtil.css(e, "paddingBottom"))
                    }
        ...
        init: function() {
            ! function() {
                ...
                KTUtil.scrollInit(n, {
                    ...
                    height: function() {
                        ...
                        return e && (n -= parseInt(KTUtil.actualHeight(e)), n -= parseInt(KTUtil.css(e, "marginBottom"))), n -= parseInt(KTUtil.css(t, "paddingTop")), n -= parseInt(KTUtil.css(t, "paddingBottom"))
                    }
                })
            }(),
            function() {
                ...
                KTUtil.scrollInit(n, {
                    ...
                    height: function() {
                        var n = parseInt(KTUtil.getViewPort().height);
                        return t && (n -= parseInt(KTUtil.actualHeight(t)), n -= parseInt(KTUtil.css(t, "marginBottom"))), n -= parseInt(KTUtil.css(e, "paddingTop")), n -= parseInt(KTUtil.css(e, "paddingBottom"))
                    }
                })
            }(),
            function() {
            ...
            function() {
                ...
                KTUtil.scrollInit(e, {
                    ...
                    height: function() {
                        var e = parseInt(KTUtil.getViewPort().height);
                        return t && (e -= parseInt(KTUtil.actualHeight(t)), e -= parseInt(KTUtil.css(t, "marginBottom"))), e -= parseInt(KTUtil.css(i, "paddingTop")), e -= parseInt(KTUtil.css(i, "paddingBottom"))
                    }
                })
            }()
        }
...
var KTQuickSearch = function() {
        var t, e, n, i, a, o, l, s, r = "",
            ...
            K = function() {
                ...
                r = n.value, KTUtil.removeClass(t, T), f = !0, KTUtil.addClass(s, _), i && KTUtil.hide(i), setTimeout(function() {
                    $.ajax({
                        ...
                        error: function(e) {
                            c = !1, u(), KTUtil.addClass(t, T), KTUtil.setHTML(a, '<span class="kt-quick-search__message">Connection error. Pleae try again later.</div>'), p(), KTUtil.scrollUpdate(a)
                        }
                    })
                }, 1e3)
            },
