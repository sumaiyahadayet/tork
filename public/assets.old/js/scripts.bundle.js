                ...
                var l = {
                    ...
                    adjustCellsWidth: function() {
                        ...
                        if (a > 0) {
                            ...
                            var o = {};
                            t(i.table).find(".kt-datatable__row").find(".kt-datatable__cell").not(".kt-datatable__toggle-detail").not(":hidden").each(function(e, a) {
                                var l = n,
                                    r = t(a).data("width");
                                if (void 0 !== r)
                                    if ("auto" === r) {
                                        ...
                                        if (o[s]) l = o[s];
                                            ...
                                            var d = t(i.tableBody).find('.kt-datatable__cell[data-field="' + s + '"]');
                                            l = o[s] = Math.max.apply(null, t(d).map(function() {
                                                return t(this).outerWidth()
                                            }).get())
                                        }
                                    } else l = r;
                                t(a).children().css("width", Math.ceil(l))
                            })
                        }
                        return i
                    },
                        ...
                        if (t.each(i.dataSet, function(n, r) {
                                ...
                                for (var p = 0; p < u; p += 1) {
                                    ...
                                    if (l.getObject("sort.field", e) === f.field && g.push("kt-datatable__cell--sorted"), void 0 !== f.textAlign) {
                                        var v = void 0 !== i.textAlign[f.textAlign] ? i.textAlign[f.textAlign] : "";
                                        g.push(v)
                                    }
                                    void 0 !== f.class && g.push(f.class);
                                    var h = document.createElement("td");
                                    a.addClass(h, g.join(" ")), h.setAttribute("data-field", f.field), void 0 !== f.autoHide && (!0 !== f.autoHide ? h.setAttribute("data-autohide-disabled", f.autoHide) : h.setAttribute("data-autohide-enabled", f.autoHide)), h.innerHTML = l.getObject(f.field, r), s.appendChild(h)
                                }
                                c.appendChild(s)
                            }), 0 === i.dataSet.length) {
                    ...
                    getData: function() {
                        ...
                        if ("local" === o.data.type && (e.url = o.data.source), "remote" === o.data.type) {
                            ...
                            l.getOption("data.serverPaging") || delete a.pagination, l.getOption("data.serverSorting") || delete a.sort, e.data = t.extend({}, e.data, a, l.getOption("data.source.read.params")), "string" != typeof(e = t.extend({}, e, l.getOption("data.source.read"))).url && (e.url = l.getOption("data.source.read")), "string" != typeof e.url && (e.url = l.getOption("data.source"))
                        }
                    ...
                    paging: function(e, n) {
                        var o = {
                            ...
                            callback: null,
                            init: function(e) {
                                o.meta = e, o.meta.page = parseInt(o.meta.page), o.meta.pages = parseInt(o.meta.pages), o.meta.perpage = parseInt(o.meta.perpage), o.meta.total = parseInt(o.meta.total), o.meta.pages = Math.max(Math.ceil(o.meta.total / o.meta.perpage), 1), o.meta.page > o.meta.pages && (o.meta.page = o.meta.pages), o.paginateEvent = l.getTablePrefix(), o.pager = t(i.table).siblings(".kt-datatable__pager"), t(o.pager).hasClass("kt-datatable--paging-loaded") || (t(o.pager).remove(), 0 !== o.meta.pages && (l.setDataSourceParam("pagination", {
                                    page: o.meta.page,
                                    pages: o.meta.pages,
            ...
            var l = {
                ...
                r = {
                    ...
                    setActiveItem: function(t) {
                        ...
                        for (var e = KTUtil.parents(t, ".kt-menu__item--submenu"), a = 0, n = e.length; a < n; a++) KTUtil.addClass(e[a], "kt-menu__item--open")
                    },
