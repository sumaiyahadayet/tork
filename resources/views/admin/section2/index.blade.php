            ...
            <div class="kt-portlet__head-wrapper">
                <div class="kt-portlet__head-actions">
                    ...
                    <div class="dropdown dropdown-inline">
                        <a href="{{route('add-section2')}}" class="btn btn-success btn-icon-sm">
            ...
            <tbody>
              ...
              @endphp
                ...
                <tr>
                    ...
                    <td>
                        <img src="{{asset($section2->image)}}" style="height:80px;width:auto" alt="">
                    </td>

                    <td>{{$section2->order}}</td>
                    <td>
                     <a href="/admin/edit-section2/{{$section2->id}}" class="edit"><i class="la la-edit" data-toggle="tooltip" title="Edit"></i></a>
                     <a href="/admin/delete-section2/{{$section2->id}}" class="delete"> <i class="la la-trash" data-toggle="tooltip" title="Delete"></i> </a>
                    </td>
                    <td>{{$section2->created_at}}</td>
...
{{-- <div id="updatesection2Modal" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="post" action="{{route('update-section2')}}" enctype="multipart/form-data">
                @csrf
                <div class="modal-header">
