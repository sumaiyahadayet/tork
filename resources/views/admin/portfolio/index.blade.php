            ...
            <div class="kt-portlet__head-wrapper">
                <div class="kt-portlet__head-actions">
                    ...
                    <div class="dropdown dropdown-inline">
                        <a href="{{route('add-portfolio')}}" class="btn btn-success btn-icon-sm">
            ...
            <tbody>
              ...
              @endphp
                ...
                <tr>
                    ...
                    <td>
                     <a href="/admin/edit-portfolio/{{$portfolio->id}}" class="edit"><i class="la la-edit" data-toggle="tooltip" title="Edit"></i></a>
                     <a href="/admin/delete-portfolio/{{$portfolio->id}}" class="delete"> <i class="la la-trash" data-toggle="tooltip" title="Delete"></i> </a>
                    </td>
