            ...
            <div class="kt-portlet__head-wrapper">
                <div class="kt-portlet__head-actions">
                    ...
                    <div class="dropdown dropdown-inline">
                        <a href="/admin/add-category" class="btn btn-success btn-icon-sm">
            ...
            <tbody>
              ...
              @endphp
                ...
                <tr>
                    ...
                    {{-- <td>{{$portfolio->serial}}</td> --}}
                    <td>{{$serial}}</td>
                    {{-- <td>
                        <img src="{{asset($portfolio->image)}}" style="height:80px;width:auto" alt="">
                    </td> --}}
                    <td>{{$category->title}}</td>
                    <td>{{$category->order}}</td>

                    <td>
                     <a href="/admin/edit-category/{{$category->id}}" class="edit" ><i class="la la-edit" data-toggle="tooltip" title="Edit"></i></a>
                     <a href="/admin/delete-category/{{$category->id}}" class="delete"><i class="la la-trash" data-toggle="tooltip" title="Delete"></i></a>
                    </td>
