...
<div class="kt-portlet kt-portlet--mobile">
            ...
            <div class="kt-portlet__head-wrapper">
                <div class="kt-portlet__head-actions">
                    ...
                    <div class="dropdown dropdown-inline">
                        <a href="{{route('add-projects')}}" class="btn btn-success btn-icon-sm">
    ...
    <div class="kt-portlet__body kt-portlet__body--fit">
        ...
        <table class="kt-datatable" id="html_table" width="100%">
             ...
             <thead>
                 <tr>
                     <th title="Field #4">Serial</th>
                     <th title="Field #4">Image Big</th>
                     <th title="Field #3">Url Big</th>
                     <th title="Field #4">Image Small</th>
                     <th title="Field #3">Url Small</th>
                     <th title="Field #5">Section Type</th>
                     <th title="Field #5">Order</th>
                     <th  title="Field #2">Actions</th>
                     <th class="d-print-none" title="Field #8">Created At</th>
                 </tr>
             </thead>
          ...
          @foreach($data as $projects)
               ...
               <tr>
                    ...
                    <td>{{$serial}}</td>
                        <td>
                           <img src="{{asset($projects->imageb)}}" style="height:80px;width:auto" alt="">
                        </td>
                        <td>{{$projects->urlb}}</td>
                        <td>
                           <img src="{{asset($projects->images)}}" style="height:80px;width:auto" alt="">
                        </td>
                        <td>{{$projects->urls}}</td>
                        <td>{{$projects->type}}</td>
                        <td>{{$projects->order}}</td>
                        <td>
                         <a href="/admin/edit-projects/{{$projects->id}}" class="edit"><i class="la la-edit" data-toggle="tooltip" title="Edit"></i></a>
                         <a href="/admin/delete-projects/{{$projects->id}}" class="delete"> <i class="la la-trash" data-toggle="tooltip" title="Delete"></i> </a>
                        </td>
